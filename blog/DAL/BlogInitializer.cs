...
namespace blog.DAL
{
    ...
    public class BlogInitializer : System.Data.Entity.DropCreateDatabaseAlways<BlogContext>
    {
        ...
        protected override void Seed(BlogContext context)
        {
            ...
            {
                new Post {ID = postID1, Author = "Brian Matu", AuthorWebsiteUrl = "https://www.google.co.il", Title = "Fast and Furious 1", Date = DateTime.Parse("2001-05-17"), Content = "The Fast and the Furious (also known as Fast & Furious) is an American franchise including a series of action films, which center around illegal street racing and heists, and various other media portraying the characters and situations from the films. Distributed by Universal Pictures, the series was established with the 2001 film titled The Fast and the Furious; followed by six sequels, two short films that tie into the series, and as of May 2015,[1] it has become Universal's biggest franchise of all time." },
                new Post {ID = postID2, Author = "David O'conor", AuthorWebsiteUrl = "https://www.ynet.co.il", Title = "Only the strong", Date = DateTime.Parse("1993-03-12"), Content = "Only the Strong is a 1993 martial arts film directed by Sheldon Lettich, starring Mark Dacascos. It is considered to be the only Hollywood film that showcases capoeira, an Afro-Brazilian martial art, from beginning to end." }
            };
